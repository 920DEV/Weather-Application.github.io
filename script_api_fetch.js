...
const fetch_weather_api= async(weather_location)=>{
	...
	let S_name= data.location.region;
	...
	locationDetails(c_ountry,S_name,local_time,time_zone,cond_ition,hum,temper)
};
...
function locationDetails(c_ountry,S_name,local_time,time_zone,cond_ition,hum,temper){
